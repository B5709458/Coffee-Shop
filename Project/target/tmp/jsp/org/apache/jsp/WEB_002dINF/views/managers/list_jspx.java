...
public final class list_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_page_list_0(PageContext _jspx_page_context)
    ...
    _jspx_th_page_list_0.setZ("iQmpdW2xcnPm1EJfwdoaZTOZUHU=");
    _jspx_th_page_list_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${managers}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_page_list_0.setId("pl_com_springsource_roo_coffeeshop_domain_Manager");
  ...
  private boolean _jspx_meth_table_table_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_table_0.setZ("jGQ+1BLts/LVOKjv9kfaFEeqFak=");
    _jspx_th_table_table_0.setPath("/managers");
    _jspx_th_table_table_0.setId("l_com_springsource_roo_coffeeshop_domain_Manager");
    _jspx_th_table_table_0.setData((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${managers}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_table_column_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_0.setZ("QrqrZJ1Ea2z+55GtEp7F/8n4Auw=");
    _jspx_th_table_column_0.setProperty("managerID");
    _jspx_th_table_column_0.setId("c_com_springsource_roo_coffeeshop_domain_Manager_ManagerID");
  ...
  private boolean _jspx_meth_table_column_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_1.setZ("aiN0PqUGTeo+ZjETBm9WW5Uq18w=");
    _jspx_th_table_column_1.setProperty("managerFirstName");
    _jspx_th_table_column_1.setId("c_com_springsource_roo_coffeeshop_domain_Manager_ManagerFirstName");
  ...
  private boolean _jspx_meth_table_column_2(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_2.setZ("71cGs3dFtvzTJnFDxaClVi/0FpA=");
    _jspx_th_table_column_2.setProperty("managerLastName");
    _jspx_th_table_column_2.setId("c_com_springsource_roo_coffeeshop_domain_Manager_ManagerLastName");
  ...
  private boolean _jspx_meth_table_column_3(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_3.setZ("2/NWHqkqkkppUbumUlg+6TfWtUQ=");
    _jspx_th_table_column_3.setProperty("managerPhone");
    _jspx_th_table_column_3.setId("c_com_springsource_roo_coffeeshop_domain_Manager_ManagerPhone");
