...
public final class create_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_form_create_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_create_0.setZ("Pjiyv8dol4/ay7zm6Cc+WHoHzfE=");
    ...
    _jspx_th_form_create_0.setPath("/managers");
    _jspx_th_form_create_0.setModelAttribute("manager");
    _jspx_th_form_create_0.setId("fc_com_springsource_roo_coffeeshop_domain_Manager");
  ...
  private boolean _jspx_meth_field_input_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_0.setZ("2UrhEaS/yq+Fdcr3ilbM2uiFUVk=");
    _jspx_th_field_input_0.setRequired(new Boolean(true));
    _jspx_th_field_input_0.setMin("2");
    _jspx_th_field_input_0.setId("c_com_springsource_roo_coffeeshop_domain_Manager_ManagerID");
    _jspx_th_field_input_0.setField("ManagerID");
  ...
  private boolean _jspx_meth_field_input_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_1.setZ("AedOKdCsHQiBQ2BEM1pWZREpnZE=");
    _jspx_th_field_input_1.setRequired(new Boolean(true));
    _jspx_th_field_input_1.setMin("2");
    _jspx_th_field_input_1.setId("c_com_springsource_roo_coffeeshop_domain_Manager_ManagerFirstName");
    _jspx_th_field_input_1.setField("ManagerFirstName");
  ...
  private boolean _jspx_meth_field_input_2(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_2.setZ("IblFJ6WFch74hqb9UdXx6scbrPk=");
    _jspx_th_field_input_2.setRequired(new Boolean(true));
    _jspx_th_field_input_2.setMin("2");
    _jspx_th_field_input_2.setId("c_com_springsource_roo_coffeeshop_domain_Manager_ManagerLastName");
    _jspx_th_field_input_2.setField("ManagerLastName");
  ...
  private boolean _jspx_meth_field_input_3(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_3.setZ("ECgyPf1Nx1q0AWubZ98eVX+PjV0=");
    _jspx_th_field_input_3.setRequired(new Boolean(true));
    _jspx_th_field_input_3.setMin("2");
    _jspx_th_field_input_3.setId("c_com_springsource_roo_coffeeshop_domain_Manager_ManagerPhoneNumber");
    _jspx_th_field_input_3.setField("ManagerPhoneNumber");
  ...
  private boolean _jspx_meth_form_dependency_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_dependency_0.setZ("Q0uhyc4u9GOhMbBtBUKlAZIVpBE=");
    ...
    _jspx_th_form_dependency_0.setId("d_com_springsource_roo_coffeeshop_domain_Manager");
