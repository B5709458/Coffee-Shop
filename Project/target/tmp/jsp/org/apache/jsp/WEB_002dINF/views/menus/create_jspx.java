...
public final class create_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_form_create_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_create_0.setZ("kTHXyzW1X4Sw1Ro4AALPrZjmN5U=");
    ...
    _jspx_th_form_create_0.setPath("/menus");
    _jspx_th_form_create_0.setModelAttribute("menu");
    _jspx_th_form_create_0.setId("fc_com_springsource_roo_coffeeshop_domain_Menu");
  ...
  private boolean _jspx_meth_field_input_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_0.setZ("LszUIjdW3qCsXfLCB2KQgRCJIp0=");
    _jspx_th_field_input_0.setRequired(new Boolean(true));
    _jspx_th_field_input_0.setMin("2");
    _jspx_th_field_input_0.setId("c_com_springsource_roo_coffeeshop_domain_Menu_DrinkID");
    _jspx_th_field_input_0.setField("DrinkID");
  ...
  private boolean _jspx_meth_field_input_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_1.setZ("c0b0E6xAEcpGPN0Oh+URi7CweKg=");
    _jspx_th_field_input_1.setRequired(new Boolean(true));
    _jspx_th_field_input_1.setMin("2");
    _jspx_th_field_input_1.setId("c_com_springsource_roo_coffeeshop_domain_Menu_DrinkName");
    _jspx_th_field_input_1.setField("DrinkName");
  ...
  private boolean _jspx_meth_field_input_2(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_2.setZ("VENuutwlOjW+W1ACb4TXcKQbdUQ=");
    _jspx_th_field_input_2.setRequired(new Boolean(true));
    _jspx_th_field_input_2.setId("c_com_springsource_roo_coffeeshop_domain_Menu_Sizes");
    _jspx_th_field_input_2.setField("Sizes");
  ...
  private boolean _jspx_meth_field_input_3(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_3.setZ("SOkVFaaRTKOEAPCj84S31xRWpB4=");
    _jspx_th_field_input_3.setValidationMessageCode("field_invalid_number");
    _jspx_th_field_input_3.setId("c_com_springsource_roo_coffeeshop_domain_Menu_Price");
    _jspx_th_field_input_3.setField("Price");
  ...
  private boolean _jspx_meth_field_select_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_select_0.setZ("0bE/k+BroO+QgPZt29E3GDfoE7g=");
    _jspx_th_field_select_0.setPath("/managers");
    _jspx_th_field_select_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${managers}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_field_select_0.setItemValue("id");
    _jspx_th_field_select_0.setId("c_com_springsource_roo_coffeeshop_domain_Menu_ManagerEdit");
    _jspx_th_field_select_0.setField("ManagerEdit");
  ...
  private boolean _jspx_meth_form_dependency_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_dependency_0.setZ("sCr5sOKSVngpHzgWfjaxHqxCyH8=");
    ...
    _jspx_th_form_dependency_0.setId("d_com_springsource_roo_coffeeshop_domain_Menu");
