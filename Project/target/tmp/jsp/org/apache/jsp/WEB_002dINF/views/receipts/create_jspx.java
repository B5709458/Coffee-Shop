...
public final class create_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_form_create_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_create_0.setZ("a3pABNZBy1WnHgvMrECrW9ZU9gY=");
    ...
    _jspx_th_form_create_0.setPath("/receipts");
    _jspx_th_form_create_0.setModelAttribute("receipt");
    _jspx_th_form_create_0.setId("fc_com_springsource_roo_coffeeshop_domain_Receipt");
  ...
  private boolean _jspx_meth_field_input_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_0.setZ("yp6+RXnNYmbczyMVaaQO76dHKzg=");
    _jspx_th_field_input_0.setRequired(new Boolean(true));
    _jspx_th_field_input_0.setMin("2");
    _jspx_th_field_input_0.setId("c_com_springsource_roo_coffeeshop_domain_Receipt_ReceiptID");
    _jspx_th_field_input_0.setField("ReceiptID");
  ...
  private boolean _jspx_meth_field_select_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_select_0.setZ("TVmOhHq6ftHfzMqxlcKv2iNhbAM=");
    _jspx_th_field_select_0.setPath("/orderses");
    _jspx_th_field_select_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${orderses}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_field_select_0.setItemValue("id");
    _jspx_th_field_select_0.setId("c_com_springsource_roo_coffeeshop_domain_Receipt_Orders");
    _jspx_th_field_select_0.setField("Orders");
  ...
  private boolean _jspx_meth_field_datetime_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_datetime_0.setZ("aYwHFe914fBzC19fXfmiuy7wKwQ=");
    _jspx_th_field_datetime_0.setId("c_com_springsource_roo_coffeeshop_domain_Receipt_Dates");
    _jspx_th_field_datetime_0.setField("Dates");
    _jspx_th_field_datetime_0.setDateTimePattern((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${receipt_dates_date_format}", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_field_input_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_1.setZ("tJkIlioy3P1cr/Htbe+KQ7gxokU=");
    _jspx_th_field_input_1.setRequired(new Boolean(true));
    _jspx_th_field_input_1.setId("c_com_springsource_roo_coffeeshop_domain_Receipt_Times");
  ...
  private boolean _jspx_meth_field_select_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_select_1.setZ("olIf+TYWJx1HqY8fVLI0tvzA+8U=");
    _jspx_th_field_select_1.setPath("/employees");
    _jspx_th_field_select_1.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${employees}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_field_select_1.setItemValue("id");
    _jspx_th_field_select_1.setId("c_com_springsource_roo_coffeeshop_domain_Receipt_Employee");
    _jspx_th_field_select_1.setField("Employee");
  ...
  private boolean _jspx_meth_field_checkbox_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_checkbox_0.setZ("h41W3eyvEzoaim/wSnIpBBuKtk8=");
    _jspx_th_field_checkbox_0.setId("c_com_springsource_roo_coffeeshop_domain_Receipt_Status");
  ...
  private boolean _jspx_meth_form_dependency_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_dependency_0.setZ("EbKYK0WXcXL7UtTtr57cOjWiYTA=");
    ...
    _jspx_th_form_dependency_0.setId("d_com_springsource_roo_coffeeshop_domain_Receipt");
