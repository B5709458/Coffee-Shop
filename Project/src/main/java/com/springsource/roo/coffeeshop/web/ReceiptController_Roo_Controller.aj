...
privileged aspect ReceiptController_Roo_Controller {
    ...
    void ReceiptController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("receipt_dates_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
