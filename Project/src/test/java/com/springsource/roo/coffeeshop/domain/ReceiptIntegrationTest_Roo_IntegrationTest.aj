...
privileged aspect ReceiptIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ReceiptIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ReceiptIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: ReceiptIntegrationTest: @Transactional;
    
    @Autowired
    ReceiptDataOnDemand ReceiptIntegrationTest.dod;
    
    @Test
    public void ReceiptIntegrationTest.testCountReceipts() {
    ...
    @Test
    public void ReceiptIntegrationTest.testFindReceipt() {
    ...
    @Test
    public void ReceiptIntegrationTest.testFindAllReceipts() {
        Assert.assertNotNull("Data on demand for 'Receipt' failed to initialize correctly", dod.getRandomReceipt());
        long count = Receipt.countReceipts();
    ...
    @Test
    public void ReceiptIntegrationTest.testFindReceiptEntries() {
        Assert.assertNotNull("Data on demand for 'Receipt' failed to initialize correctly", dod.getRandomReceipt());
        long count = Receipt.countReceipts();
    ...
    @Test
    public void ReceiptIntegrationTest.testFlush() {
        Receipt obj = dod.getRandomReceipt();
        Assert.assertNotNull("Data on demand for 'Receipt' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Receipt' failed to provide an identifier", id);
    ...
    @Test
    public void ReceiptIntegrationTest.testMergeUpdate() {
        Receipt obj = dod.getRandomReceipt();
        Assert.assertNotNull("Data on demand for 'Receipt' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Receipt' failed to provide an identifier", id);
    ...
    @Test
    public void ReceiptIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Receipt' failed to initialize correctly", dod.getRandomReceipt());
    ...
    @Test
    public void ReceiptIntegrationTest.testRemove() {
        Receipt obj = dod.getRandomReceipt();
        Assert.assertNotNull("Data on demand for 'Receipt' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Receipt' failed to provide an identifier", id);
